...
This is not a collection of tutorial-level code.
This is a structured, progressive engineering portfolio designed to demonstrate:
...
- Future API extraction in mind
- Database replacement flexibility
