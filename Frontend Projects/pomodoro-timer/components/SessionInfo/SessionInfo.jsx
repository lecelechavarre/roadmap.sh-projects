...
import { secondsToMinutes, minutesToSeconds } from '../../utils/timeFormatter';
...
export const Settings = () => {
  ...
  const handleChange = (e) => {
    ...
    setLocalSettings(prev => ({
      ...prev,
      [name]: Math.max(1, Math.min(60, numValue))
    }));
  };
  ...
  const handleIntervalChange = (e) => {
    ...
    setLocalSettings(prev => ({
      ...prev,
      longBreakInterval: Math.max(1, Math.min(10, value))
    }));
  };
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    updateSettings({
      workDuration: minutesToSeconds(localSettings.workDuration),
      shortBreakDuration: minutesToSeconds(localSettings.shortBreakDuration),
      longBreakDuration: minutesToSeconds(localSettings.longBreakDuration),
